...
# Company-wide analytics dashboard. Field sales, inside_sales, and estimating
# disciplines are excluded. Reps use their own pipeline, not this dashboard.
...
def require_analytics_dashboard(user: dict) -> None:
    """403 unless the role may open the company-wide analytics dashboard."""
