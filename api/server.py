...
async def dashboard_inside_sales(_user: dict = Depends(require_auth)) -> dict:
    # Pipeline counts follow the same field-sales book as GET /api/leads
    # (sales, maintenance_sales, install_sales). inside_sales and manager-type
    # roles keep the company-wide totals. The predicate is inserted
