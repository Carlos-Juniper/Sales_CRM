...
import { useLeads, type LeadScope } from '@/hooks/useLeads'
...
interface LeadListViewProps {
  title: string
  /** Narrows the feed — gov sources for Public Leads, `mine` for the Leads tab. */
  scope?: LeadScope
  /** Only the user-scoped tab creates leads; the gov feed is scraper-fed. */
  showAddLead?: boolean
  emptyTitle?: string
...
export function LeadListView({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <TopNav title={title} subtitle={`${total} total leads`} />
